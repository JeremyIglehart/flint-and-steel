...
const BrandMark = () => (
  <svg
    ...
    viewBox="0 0 864 864"
    className="w-72 md:w-[21.5rem] lg:w-96 h-auto text-[#231f20] fill-current"
    aria-hidden="true"
  >
    {/* .st0 Paths: Fill only */}
    <path
    ...
    />
    {/* .st1 Paths: Fill, Stroke, and Stroke Width */}
    <path
      fill="#231f20"
      stroke="#231f20"
      strokeWidth="0.12"
    ...
    />
    {/* .st2 Lines: No fill, Stroke and Stroke Width */}
    <line
      fill="none"
      stroke="#231f20"
      strokeWidth="0.5"
...
export function HomePage() {
  return (
    <main className="min-h-[100dvh] bg-[#F7F6F2] flex flex-col items-center justify-center p-6 sm:p-12 overflow-x-hidden selection:bg-[#D95C3C]/10">
      ...
      >
        {/* Brand Mark Visual Anchor with Increased Scale */}
        <div className="mb-16">
          <BrandMark />
        </div>
        {/* Primary Invocation with Italic Styling */}
