...
const BrandMark = () => (
  <svg
    ...
    viewBox="0 0 864 864"
    className="w-60 md:w-72 h-auto text-[#231f20] fill-current"
    aria-hidden="true"
  >
    <path
      d="M279.4,193.27h120.42l-89.06,198.17,262.09-198.17h126.29l-348.1,224.5,59.13,57.19-12.75,53.97s-3.98-11.39-9.3-19.02c-6.11-8.77-13.66-13.94-13.66-13.94l7.23,22.16s-12.15-15.91-29.76-33.59c-25.56-25.64-59.6-56.08-59.6-56.08l-68.99,108.46h-37.47l93.54-343.66Z"
    />
    <polygon points="528.56 630.84 121.61 630.84 121.19 551.87 446.53 552.15 528.56 630.84" />
    <polygon points="488.11 562.12 577.38 562.12 729.36 680.94 614.23 678.63 488.11 562.12" />
    <g>
      <path
