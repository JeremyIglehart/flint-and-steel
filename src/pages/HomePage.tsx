 ...
 * Optimized for high-fidelity rendering with refined stroke weights.
 */
const BrandMark = () => (
  <svg
    id="Layer_1"
...
export function HomePage() {
  ...
  return (
    <main className="min-h-[100dvh] bg-[#EDE8E0] flex flex-col items-center justify-center px-6 pt-4 pb-20 md:px-12 selection:bg-[#D95C3C]/15 overflow-y-auto">
      <motion.div
      ...
      >
        {/* Visual Anchor: Refined spacing for tighter identity grouping */}
        <div className="mb-2 md:mb-4">
          <BrandMark />
        </div>
        {/* Primary Invocation: Italics with refined vertical transition */}
        ...
        {/* Contemplative Body: Optimized for poetic rhythm and line length */}
