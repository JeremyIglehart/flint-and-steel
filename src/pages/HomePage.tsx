...
/**
 * Refined BrandMark SVG.
 * Optimized for maintainability by using currentColor for fills and strokes.
 */
const BrandMark = () => (
  <svg
...
export function HomePage() {
  return (
    <main className="min-h-[100dvh] bg-[#EDE8E0] flex flex-col items-center justify-center px-6 py-12 md:px-12 selection:bg-[#D95C3C]/15">
      <motion.div
      ...
      >
        ...
        <h1 className="text-xl md:text-3xl text-foreground font-semibold tracking-tight text-center mb-8 md:mb-10 text-balance italic opacity-90">
          No sense in rushing to become.
        </h1>
        {/* Contemplative Body: Optimized tracking and leading for readability */}
        <p className="text-base md:text-lg text-muted-foreground leading-[1.8] md:leading-[2] tracking-[0.015em] max-w-[38ch] mx-auto text-center font-normal text-balance">
