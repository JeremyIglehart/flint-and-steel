...
/**
 * Finalized BrandMark SVG.
 * Stroke weights adjusted for clarity across all display resolutions.
 * Using strokeLinecap and strokeLinejoin to preserve the 'maker's mark' warmth.
 */
const BrandMark = () => (
  <svg
    id="FlintAndSteelMark"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 864 864"
    className="w-64 md:w-80 lg:w-96 h-auto text-foreground fill-current"
    aria-hidden="true"
  >
    {/* Main Body Path */}
    <path
    ...
    />
    {/* Fine Detailed Marks - Stroke adjusted for visibility */}
    <path
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
...
export function HomePage() {
  ...
  return (
    <main className="min-h-[100dvh] bg-[#EDE8E0] flex flex-col items-center justify-center px-6 py-12 md:px-12 selection:bg-[#D95C3C]/15 overflow-y-auto">
      <motion.div
      ...
      >
        ...
        <h1 className="text-xl md:text-3xl text-foreground font-semibold tracking-tight text-center mb-8 md:mb-10 text-balance italic opacity-85">
          No sense in rushing to become.
        </h1>
        {/* Contemplative Body: Optimized tracking and leading for readability */}
        <p className="text-base md:text-lg text-muted-foreground leading-[1.85] md:leading-[2.1] tracking-[0.02em] max-w-[38ch] mx-auto text-center font-normal text-balance">
