...
/**
 * Refined Flint & Steel Brand Mark.
 * Simplified high-fidelity SVG with standard React attributes for reliable rendering.
 */
const BrandMark = () => (
  <svg
    id="Layer_1"
    ...
    viewBox="0 0 864 864"
    className="w-64 md:w-80 lg:w-96 h-auto text-[#231f20] fill-current"
    aria-hidden="true"
  >
    <path
      fill="#231f20"
  ...
  return (
    <main className="min-h-[100dvh] bg-[#EDE8E0] flex flex-col items-center justify-center px-6 py-12 md:px-12 selection:bg-[#D95C3C]/10">
      ...
      >
        ...
        <h1 className="text-xl md:text-3xl text-[#231f20] font-bold tracking-tight text-center mb-8 text-balance italic">
          No sense in rushing to become.
        </h1>
        {/* Contemplative Body: Strict 36ch Width Constraint */}
        <p className="text-base md:text-lg text-[#3A3935] leading-[2.1] md:leading-[2.3] tracking-wide max-w-[36ch] mx-auto text-center font-medium text-balance">
